class dataAirtelList {
  bool status;
  String message;
  Data data;

  dataAirtelList({this.status, this.message, this.data});

  dataAirtelList.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    if (json['airtel'] != null) {
      airtel = new List<Airtel>();
      json['airtel'].forEach((v) {
        airtel.add(new Airtel.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    if (this.airtel != null) {
      data['airtel'] = this.airtel.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
