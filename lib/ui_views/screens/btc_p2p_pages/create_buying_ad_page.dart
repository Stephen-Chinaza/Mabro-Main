...
class CreateBuyingAdsPage extends StatefulWidget {
  final String coinType;
  final String coinSign;
  final String usdRate;

  const CreateBuyingAdsPage({Key key, this.coinType, this.coinSign, this.usdRate}) : super(key: key);

  @override
  _CreateBuyingAdsPageState createState() => _CreateBuyingAdsPageState();
}

class _CreateBuyingAdsPageState extends State<CreateBuyingAdsPage>  with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: TopBar(
        ...
        title: 'Ad to buy ' + widget.coinType,
        onPressed: null,
