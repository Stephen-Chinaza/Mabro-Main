...
class SellDetailsPage extends StatefulWidget {
  ...
  const SellDetailsPage({Key key, this.coinType, this.coinSign, this.usdRate, this.sellersName, this.btcPrice, this.paymentMethod}) : super(key: key);
  @override
          ...
          Container(height: 60, color:ColorConstants.secondaryColor,
            child: Center(
              child: Padding(
                ...
                child: Text('Sell '+ widget.coinType + ' cheap using NGN via Mabro Wallet in Nigeria from '+ widget.sellersName,
                    style: TextStyle(
